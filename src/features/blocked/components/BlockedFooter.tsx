...
import { BLOCKED_PAGE_MESSENGER_PHONE } from "@/features/blocked/BlockedPageData";
...
import { getMessengerHref } from "@/widgets/site-shell/lib/messengers";

export const BlockedFooter = () => {
