...
import { priceListServerApi } from "@/features/price-list/api/server";
import { PriceListContent } from "@/features/price-list/PriceListContent";

import { groupPriceListByCategory } from "./service";

const PriceListPage = async () => {
  const t = await getTranslations();
  const priceList = await priceListServerApi.getAllPriceList();
