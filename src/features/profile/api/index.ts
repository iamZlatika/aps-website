import { MeResponseDtoSchema } from "@/features/auth/api/dto";
import { mapCustomerDtoToCustomer } from "@/features/auth/lib/adapters";
import { type Customer } from "@/features/auth/types";
import {
  type TelegramLinkDto,
  TelegramLinkDtoSchema,
} from "@/features/profile/api/dto";
import { CUSTOMER_PROFILE_API } from "@/features/profile/api/endpoints";
import {
  type ChangeEmailRequestBody,
  type ChangePasswordRequestBody,
  mapTelegramLinkDtoToTelegramLink,
  type UpdateProfileNameRequestBody,
} from "@/features/profile/lib/adapters";
