...
export const DEVICE_ICONS: Record<DeviceId, ReactNode> = {
  ...
  apple: (
    ...
    >
      ...
      <path
        d="M22 14c.5-1.5 2-2 3-2-.2 1.4-1 2-3 2zm2 1c-1 0-2 .5-2.5.5S20 15 19 15c-1.6 0-3 1.6-3 4 0 2.5 1.3 5 2.6 5 .6 0 1.2-.5 1.9-.5s1.3.5 1.9.5c1.3 0 2.6-2.4 2.6-4.9 0-1.5-.8-2.4-1.6-2.8"
        fill="currentColor"
        stroke="none"
      />
