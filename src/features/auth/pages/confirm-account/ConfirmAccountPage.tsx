...
import { MODAL_PARAM, REGISTER_MODAL_VALUE } from "@/shared/lib/modalParams";
...
const ConfirmAccountPage = () => {
  ...
  const { confirm, isPending, isError, data } = useConfirmAccount();
        ...
        {isPending ? (
          ...
          <>
            ...
            <button
              ...
              onClick={() =>
                router.push(
                  `${WEBSITE_LINKS.home}?${MODAL_PARAM}=${REGISTER_MODAL_VALUE}`,
                )
              }
            >
              {t("confirmAccount.registerButton")}
            </button>
          </>
        ) : (
          <>
